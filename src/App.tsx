  ...
  return (
    <motion.div
      ...
      <svg
        ...
        <motion.path
          d="M 0 200 Q 200 200 200 400 Q 200 200 400 200 Z"
          stroke="#ffffff"
          strokeWidth="2"
          fill="none"
      ...
      <div className="relative border border-neutral-900 bg-black rounded-xl p-8 shadow-2xl">
        ...
        <div className="absolute top-4 right-4 group z-10">
          <button
            ...
            className="p-2 rounded-full bg-neutral-900 text-neutral-500 hover:bg-neutral-800 hover:text-white transition-all duration-300 focus:outline-none cursor-pointer"
